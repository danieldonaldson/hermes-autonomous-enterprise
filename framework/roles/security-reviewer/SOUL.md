...
| Goal | Tool |
|---|---|
| Recall what Honcho knows about you | `honcho_reasoning(peer='security-reviewer', query="...")` |
| Quick lookup of past observations | `honcho_search(peer='security-reviewer', query="...")` |
| Save a durable fact for future runs | `honcho_conclude(peer='security-reviewer', conclusion="...")` |
| Check your role definition | `honcho_profile(peer='security-reviewer')` |
