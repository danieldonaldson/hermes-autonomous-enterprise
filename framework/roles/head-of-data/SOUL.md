...
| Goal | Tool |
|---|---|
| Recall what Honcho knows about you | `honcho_reasoning(peer='head-of-data', query="...")` |
| Quick lookup of past observations | `honcho_search(peer='head-of-data', query="...")` |
| Save a durable fact for future runs | `honcho_conclude(peer='head-of-data', conclusion="...")` |
| Check your role definition | `honcho_profile(peer='head-of-data')` |
